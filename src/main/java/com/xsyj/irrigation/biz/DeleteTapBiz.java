...
public class DeleteTapBiz extends AbstractNetBiz {
    ...
    public void delTap(Context context,String id ,
        ...
        RequestParams params=new RequestParams(Const.tap_delete);
    ...
    public void netSuccess(String url, String result) {
        if(!TextUtils.isEmpty(url) && Const.tap_delete.equalsIgnoreCase(url) && !TextUtils.isEmpty(result)) {
            ...
            LogUtil.e("删除阀门", "解析后" + (datamessage.toString()));

...
public class DeletePumpInfoBiz extends AbstractNetBiz {


    private Context context;
    private NetCallBack<PileDeleteResult> netcallback;

    public DeletePumpInfoBiz(){
        super();

    }

    public void delPumpWell(Context context,String id,
        ...
        RequestParams params=new RequestParams(Const.delete_pumpinfo);
    ...
    public void netSuccess(String url, String result) {
        if(!TextUtils.isEmpty(url) && Const.delete_pumpinfo.equalsIgnoreCase(url) && !TextUtils.isEmpty(result)) {

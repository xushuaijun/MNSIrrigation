...
public class DeleteNetGateBiz extends AbstractNetBiz {


    private Context context;
    private NetCallBack<PileDeleteResult> netcallback;

    public DeleteNetGateBiz(){
        super();

    }

    public void delNetGate(Context context,String id ,
        ...
        RequestParams params=new RequestParams(Const.netGate_delete);
    ...
    public void netSuccess(String url, String result) {
        if(!TextUtils.isEmpty(url) && Const.netGate_delete.equalsIgnoreCase(url) && !TextUtils.isEmpty(result)) {

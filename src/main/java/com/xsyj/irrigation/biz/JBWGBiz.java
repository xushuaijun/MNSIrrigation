 ...
 */
public class JBWGBiz extends AbstractNetBiz{
    ...
    public void getInfo(Context context,String singleTasks,NetCallBack<Integer> netcallback){
        ...
        RequestParams params=new RequestParams(Const.JBWG);
    ...
    public void netSuccess(String url, String result) {
        ...
        if(!TextUtils.isEmpty(url) && Const.JBWG.equalsIgnoreCase(url) && !TextUtils.isEmpty(result)) {
            int res=0;
            try{

...
public class UpdateService extends Service {
    ...
    private static Intent installIntent(Context context,String path){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(context, "com.xsyj.irrigation.fileprovider", apkFile);
...
//        GetToast.useString(this,"asdfasdf");
        ...
        if(FileHelper.checkFileIsExists(path)){
           Intent i = installIntent(getApplicationContext(),path);
...
//            final File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/irrigation",
